...
def _classify_email(claude, subject, sender, body, atts, date) -> dict:
    ...
    prompt = (
        ...
        '"spam"=masowa reklama/newsletter/promocja od sklepów — NIE dotyczy: powiadomień bankowych, alertów bezpieczeństwa, potwierdzeń transakcji, wyciągów, przypomnień o płatności, powiadomień z serwisów których użytkownik używa (GitHub, Supabase, Render, Steam itp.) — te idą do "inne". '
        '"inne"=wszystko co nie pasuje do pozostałych, w tym: powiadomienia bankowe, alerty konta, potwierdzenia zakupów, statusy zamówień, powiadomienia systemowe, newslettery tematyczne które dotyczą działalności firmy.\n'
